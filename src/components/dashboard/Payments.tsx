      ...
      <div className="space-y-6 animate-fade-in w-full">
        <PageHeader 
          ...
          actionButton={{
            ...
            onClick: () => {
              const element = document.getElementById("issue-invoice-form");
              if (element) {
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
              ...
              <CustomTable
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    accessor: (inv) => <span className="text-slate-600 dark:text-slate-400 max-w-[150px] truncate">{inv.description}</span>
                  },
                  {
                    header: "Due Date",
          ...
          {/* Form */}
          <div id="issue-invoice-form" className="xl:col-span-4 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl p-6 shadow-sm shadow-slate-100/10 h-fit transition-all duration-300">
            ...
            <form onSubmit={handleCreateInvoice} className="space-y-4">
              <div>
                <label className="text-xs font-bold text-slate-400 block mb-1">Target Student</label>
                <select 
                  required 
              ...
              <div>
                <label className="text-xs font-bold text-slate-400 block mb-1">Invoiced Fee (EUR)</label>
                <input 
                  type="number" 
                  step="0.01"
                  required 
                  ...
                  className="w-full px-3.5 py-2 text-sm rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 outline-none focus:border-[#256ff1] focus:ring-1 focus:ring-[#256ff1]/10 transition-all font-medium font-mono"
                />
              </div>

              <div>
                <label className="text-xs font-bold text-slate-400 block mb-1">Billing Reference / Description</label>
                <input 
                  type="text" 
                  required 
